...
export type GraphNode = { id: string; label: string; kind?: GraphNodeKind; x: number; y: number; width?: number; height?: number; fill?: string; stroke?: string; color?: string; font_size?: number; group?: string | null }
